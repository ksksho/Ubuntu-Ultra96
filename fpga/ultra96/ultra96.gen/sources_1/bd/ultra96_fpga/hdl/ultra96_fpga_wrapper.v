...
//Command     : generate_target ultra96_fpga_wrapper.bd
//Design      : ultra96_fpga_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module ultra96_fpga_wrapper
   (emio_uart0_ctsn_0,
    emio_uart0_rtsn_0,
    gpio_rtl_tri_io);
  ...
  wire emio_uart0_ctsn_0;
  wire emio_uart0_rtsn_0;
  ...
  IOBUF gpio_rtl_tri_iobuf_9
       (.I(gpio_rtl_tri_o_9),
        ...
        .O(gpio_rtl_tri_i_9),
        .T(gpio_rtl_tri_t_9));
  ultra96_fpga ultra96_fpga_i
       (.emio_uart0_ctsn_0(emio_uart0_ctsn_0),
        .emio_uart0_rtsn_0(emio_uart0_rtsn_0),
